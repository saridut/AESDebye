...
// options to make the docstring more informative
    ...
    py::class_<Profile>(m, "Profile", py::module_local()) // cannot initialize in python directly
        ...
        filename : str
            ...
            .def_readonly("intensity", &Profile::intensity, "List of intensity values")
            .def_readonly("calculationTime", &Profile::calculationTime, "Time taken for the calculation")
            .def_readonly("testPassed", &Profile::testPassed, "Flag to indicate if the test passed");

    // Classes
    py::class_<ParallelHelper>(m, "ParallelHelper", py::module_local())
            .def(py::init<int, bool, bool>(), py::arg("nThreads") = -1, py::arg("useMPI") = false,
                 py::arg("verbose") = true)
            ...
            .def_readonly("world_size", &ParallelHelper::worldSize, "Total size of the MPI world")
            .def_readonly("world_rank", &ParallelHelper::worldRank, "Rank of the current process in the MPI world")
            .def_readonly("ompThreads", &ParallelHelper::ompThreads, "Number of OpenMP threads")
            .def_readonly("totalThreads", &ParallelHelper::totalThreads, "Total number of threads")
            .doc() = R"pbdoc(
    ...
    py::class_<Positions>(m, "Positions", py::module_local())
            .def(py::init<std::vector<std::string>, std::vector<std::array<double, 3>>, std::vector<std::string>, double, double>(),
                 py::arg("chemicalSymbols"), py::arg("positions"), py::arg("selectionIds") = std::vector<std::string>(),
                 py::arg("boxMin") = 1e100, py::arg("boxMax") = -1e100)
            .def_readwrite("element", &Positions::element)
            .def_readwrite("selectionIds", &Positions::selectionIds, "List of atom ids")
            .def_readwrite("chemicalSymbols", &Positions::chemicalSymbols, "List of atom elementss")
                    // static method for fromIndexList
            .def_static("fromIndexList", &Positions::fromIndexList, py::arg("positions"), py::arg("indexList"))
            .def("filterBySelectionId", &Positions::filterBySelectionId, py::arg("atomId"), R"pbdoc(
            ...
            .def("filterByElement", &Positions::filterByElement, py::arg("elementName"), R"pbdoc(
            ...
            .def("subsample", &Positions::subsample, py::arg("subSampleRatio"), py::arg("seed") = 1, R"pbdoc(
            ...
            .def("sliceCellList", &Positions::sliceCellList, py::arg("start"), py::arg("end"), R"pbdoc(
    ...
    py::class_<CellList>(m, "CellList", py::module_local())
            ...
            .def("createCellList", &CellList::createCellList, py::arg("positions"), R"pbdoc(
    ...
    py::class_<PDF>(m, "PDF", py::module_local())
            .def(py::init<double, bool>(), py::arg("boxSize") = 1, py::arg("samePositions") = true)
            .def(py::self += py::self)
            ...
            .def("toCSV", &PDF::toCSV, py::arg("filename"), py::arg("complete") = false, R"pbdoc(
            ...
            .def("readCSV", &PDF::readCSV, R"pbdoc(
                ...
                Tuple[List[float], List[float], List[int], List[float]]
                    ...
                    // properties
            .def_property_readonly("uncorrectedCenters", &PDF::getUncorrectedCenters, "List of uncorrected bin centers")
    ...
    py::class_<DebyeCalculator>(m, "DebyeCalculator", py::module_local())
            .def(py::init<int, int, double, bool, bool, bool, bool, bool, bool, bool>(),
                 py::arg("nThreads") = -1, py::arg("nCells") = 15,
                 py::arg("binsResolution") = 1.0,
                 py::arg("useMPI") = false, py::arg("useGPU") = false,
                 py::arg("useLocalHist") = true, py::arg("smallBin") = false,
                 py::arg("pseudoCoal") = true,
                 py::arg("fillGPU") = false,
                 py::arg("verbose") = true)
            .def("calculatePDF", py::overload_cast<Positions &, Positions &>(&DebyeCalculator::calculatePDF),
            ...
            .def("calculatePDF", py::overload_cast<Positions &>(&DebyeCalculator::calculatePDF),
                 py::arg("positionsI"))


            .def("calculateIntensity", py::overload_cast<std::vector<double> const &,
                         std::vector<double> const &, std::vector<double> const &,
                         std::string, std::string>(&DebyeCalculator::calculateIntensity), py::arg("centers"),
                 py::arg("counts"), py::arg("qVector"),
            ...
            .def("calculateIntensity",
                 py::overload_cast<PDF &, double, double, int, bool, double>(&DebyeCalculator::calculateIntensity),
                 py::arg("pdf"), py::arg("start"), py::arg("end"), py::arg("nSteps"),
                 py::arg("twoThetaSpace") = false, py::arg("wavelength") = 0.4)

            .def("calculateProfile",
                 py::overload_cast<Positions &, double, double, int, bool, double, std::string>(
                         &DebyeCalculator::calculateProfile),
                 py::arg("Positions"), py::arg("start") = 0, py::arg("end") = 10,
                 py::arg("steps") = 1000, py::arg("twoTheta") = false, py::arg("wavelength") = .4,
                 py::arg("filter") = "", R"pbdoc(
            ...
            .def_readonly("cellList", &DebyeCalculator::cellList, "CellList object created by the DebyeCalculator")
            .doc() = R"pbdoc(
    ...
    m.def("generateData", &generateTestData, R"pbdoc(
    ...
    m.def("readXYZ", &readXYZ,
          py::arg("filename"), py::arg("delimiter") = " ", py::arg("skipLines") = 2,
          py::arg("typeMapping") = "0:None", R"pbdoc(
